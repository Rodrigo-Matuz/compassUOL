...
Cadastrar Produto Com Sucesso
    ...
    ${nome_final}=    Run Keyword If    '${nome}' == '${EMPTY}'    Gerar Nome Produto Aleatório    ELSE    Set Variable    ${nome}
    ${descricao_final}=    Run Keyword If    '${descricao}' == '${EMPTY}'    Gerar Descrição Produto Aleatória    ELSE    Set Variable    ${descricao}
...
Obter Token De Autenticação
    ...
    ${senha_final}=    Run Keyword If    '${senha}' == '${EMPTY}'    Gerar Senha Aleatória Válida    ELSE    Set Variable    ${senha}
